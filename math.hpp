...
template<typename T,typename U,typename V>
T& clamp_m(const T target,const U low,const V high){
...
template<typename T,typename U> T& clamp_u_m(T target,const U high){
...
template<typename U> unsigned& clamp_u_m(int target,const U high){
